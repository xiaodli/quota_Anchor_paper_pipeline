...
plot = ggplot(df, aes(x=Species, y=Cluster_number)) +
  ...
  geom_point(aes(x = Species, y = Cluster_length_max * scale_factor, color = Depth, group = Depth), size = 2.5, alpha = 0.5) +
  ...
  theme(axis.title.x=element_blank(),          
        ...
        axis.text.x = element_text(size = 22, angle=300, hjust=0, vjust=1, colour = "black", face ="italic"),
        ...
        legend.key.spacing.x = unit(3.2, "cm"),
