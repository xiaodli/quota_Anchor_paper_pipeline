...
plot_total <- function (query_file_path, ref_file_path, col_file, fig_file){
  ...
  plot <- ggplot(data=data, aes(x=query_index, y=ref_index))+
    ...
    theme(axis.line = element_blank(),
          ...
          axis.text.x = element_text(angle=300, hjust=0, vjust=1, colour = "black", size = 7) ) + 
...
plot_total("../quota_Anchor_result/zm.length.txt",
           ...
           "./diamond_default_difference.txt",
           "./diamond_default_difference.png")
plot_total("../quota_Anchor_result/zm.length.txt",
           "../quota_Anchor_result/sb.length.txt",
           "./diamond_difference.txt",
           "./diamond_difference.png")
plot_total("../quota_Anchor_result/zm.length.txt",
           "../quota_Anchor_result/sb.length.txt",
           "./blast_difference.txt",
           "./blast_difference.png")
...
plot_total1 <- function (query_file_path, ref_file_path, col_file, fig_file){
  ...
  plot <- ggplot(data=data, aes(x=query_index, y=ref_index))+
    ...
    theme(axis.line = element_blank(),
          ...
          legend.title = element_text(size = 45, margin = margin(r = 0.75, unit = "cm")),
...
plot_total1("./zm.length.txt",
           "./sb.length.txt",
           "./diamond_default_difference.maize4.sorghum7_5.txt",
           "./diamond_default_difference.maize4.sorghum7_5.png")
