...
plot = ggplot(df, aes(x=species_pair, y=value, fill=factor(variable,levels = unique(variable)), )) +
  ...
  theme(axis.title.x=element_blank(),          
        ...
        axis.text.x = element_text(size = 25, angle=315, hjust=0.5, vjust=1, colour = "black"),
...
# png("/media/dell/E/Suppmentary_data/03distance/distance.R.pdf", width=1600, height=1200, res=300)
pdf("/media/dell/E/Suppmentary_data/03distance/distance.R.pdf", width=16, height=12)
print(plot)
dev.off()
