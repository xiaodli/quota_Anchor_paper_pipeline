...
pep_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/vv/output_dir/01longest
raw_data_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/vv/raw_data
array_ref=(vv)
array_query=(vv)
...
#    fi
    ...
    quota_Anchor dotplot -i \${query}_\${ref}.table -o \${query}_\${ref}.table.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "vv" -q_label "vv" --overwrite
    quota_Anchor dotplot -i \${query}_\${ref}.collinearity -o \${query}_\${ref}.collinearity.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "vv" -q_label "vv" --overwrite
" ::: "${array_query[@]}" ::: "${array_ref[@]}" ::: "${raw_data_path}"
