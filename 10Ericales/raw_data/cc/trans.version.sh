...
pep_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/cc/output_dir/01longest
raw_data_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/cc/raw_data
array_ref=(cc)
array_query=(cc)
...
#    fi
    ...
    quota_Anchor dotplot -i \${query}_\${ref}.table -o \${query}_\${ref}.table.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "cc" -q_label "cc" --overwrite
    quota_Anchor dotplot -i \${query}_\${ref}.collinearity -o \${query}_\${ref}.collinearity.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "cc" -q_label "cc" --overwrite
" ::: "${array_query[@]}" ::: "${array_ref[@]}" ::: "${raw_data_path}"
