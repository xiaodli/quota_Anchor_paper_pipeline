...
pep_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/do/output_dir/01longest
raw_data_path=/media/dell/E/Suppmentary_data/10Ericales/raw_data/do/raw_data
array_ref=(do)
array_query=(do)
...
#    fi
    ...
    quota_Anchor dotplot -i \${query}_\${ref}.table -o \${query}_\${ref}.table.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "do" -q_label "do" --overwrite
    quota_Anchor dotplot -i \${query}_\${ref}.collinearity -o \${query}_\${ref}.collinearity.png -r \$raw_data_path/\${ref}.length.txt -q \$raw_data_path/\${query}.length.txt -r_label "do" -q_label "do" --overwrite
" ::: "${array_query[@]}" ::: "${array_ref[@]}" ::: "${raw_data_path}"
