...
plot_total("/media/dell/E/Suppmentary_data/04expression_paleo_speciation/pearson_correlation_log.csv", "/media/dell/E/Suppmentary_data/04expression_paleo_speciation/pearson_correlation_log.png", "pearson")
plot_total("/media/dell/E/Suppmentary_data/04expression_paleo_speciation/spearman_correlation.csv", "/media/dell/E/Suppmentary_data/04expression_paleo_speciation/spearman_correlation.png", "pearson")
