setwd("/media/dell/E/Suppmentary_data/02Spontaneum_P.hallii_.C.macrourus_E.colona/difference_WGDI_and_soi/")
library(ggplot2)
# changetoM <- function ( position ){
#   position=position/1000000;
#   paste(position, "M", sep="")
# }
plot_total <- function (query_file_path, ref_file_path, software, col_file, fig_file, query_name, ref_name, angle=0){
  ...
  plot <- ggplot(data=data, aes(x=query_index, y=ref_index))+
    ...
    theme(axis.line = element_blank(),
          ...
          strip.text.x = element_text(size = 16, angle=angle, hjust=0.3, vjust=0.5),
...
plot_total("/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Panicum.hallii.length.txt",
           ...
           "WGDI",
           "./WGDI_Panicum.txt",
           "./WGDI_Panicum_diamond_difference.pdf",
           "Panicum hallii",
...
plot_total("Cenchrus.macrourus.length.txt",
           "/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Saccharum.spontaneum.length.txt",
           "WGDI",
           "./rm_GWHBWDX000000_WGDI_Cenchrus.txt",
           "./WGDI_Cenchrus_diamond_difference.pdf",
           "Cenchrus macrourus",
           "Saccharum spontaneum",
           0)
plot_total("/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Echinochloa.colona.length.txt",
           "/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Saccharum.spontaneum.length.txt",
           "WGDI",
           "./WGDI_Echinochloa.txt",
           "./WGDI_Echinochloa_diamond_differencee.pdf",
           "Echinochloa colona",
           "Saccharum spontaneum",
           60)
...
plot_total("/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Panicum.hallii.length.txt",
           ...
           "SOI",
           "./soi_Panicum.txt",
           "./soi_Panicum_difference.pdf",
           "Panicum hallii",
           "Saccharum spontaneum")
plot_total("Cenchrus.macrourus.length.txt",
           "/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Saccharum.spontaneum.length.txt",
           "SOI",
           "./rm_GWHBWDX000000_soi_Cenchrus.txt",
           "./soi_Cenchrus_difference.pdf",
           "Cenchrus macrourus",
           "Saccharum spontaneum")
plot_total("/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Echinochloa.colona.length.txt",
           "/media/dell/E/Suppmentary_data/05sequence/01pipeline_raw_data/Saccharum.spontaneum.length.txt",
           "SOI",
           "./soi_Echinochloa.txt",
           "./soi_Echinochloa_difference.pdf",
           "Echinochloa colona",
           "Saccharum spontaneum",
           60)
