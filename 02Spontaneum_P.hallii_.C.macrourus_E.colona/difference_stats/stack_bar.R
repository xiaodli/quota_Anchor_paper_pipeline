...
plot_total("./cm.bar_difference_R.txt", "./cm.bar_difference_R.pdf", "Number of collinear gene pairs")
plot_total("./ph.bar_difference_R.txt", "./ph.bar_difference_R.pdf", "Number of collinear gene pairs")
plot_total("./ec.bar_difference_R.txt", "./ec.bar_difference_R.pdf", "Number of collinear gene pairs")
